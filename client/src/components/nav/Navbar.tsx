...
const NAV_GROUPS: NavGroup[] = [
  {
    ...
    items: [
      ...
      { label: "Station Bonuses", href: "/tools/refinery-stations" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Reputation", href: "/tools/reputation" },
      { label: "Law System", href: "/tools/law" },
  ...
  },
  {
    ...
    items: [
      ...
      { label: "Contracts", href: "/guides/contracts" },
